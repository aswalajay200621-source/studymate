 ...
 */
export const listSubjects = async (params?: ListSubjectsParams, options?: RequestInit): Promise<SubjectSummary[]> => {

  return customFetch<SubjectSummary[]>(getListSubjectsUrl(params),
  {
    ...options,
    method: 'GET'
 ...
 */
export const getSubject = async (id: string, options?: RequestInit): Promise<SubjectWithChapters> => {
...
export const getGetChapterQueryOptions = <TData = Awaited<ReturnType<typeof getChapter>>, TError = ErrorType<ErrorResponse>>(id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getChapter>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
